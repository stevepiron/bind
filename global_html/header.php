...
<header class="clearfix">
	<div class="pp_loggedIn">
		<a id="logoAnchor" href="<?php echo $dig; ?>index.php#loggedIn"><img id="logo" src="<?php echo $dig; ?>media/img/assets/bind-logo-knot@2x.png" alt="Bind" width="47" height="25"> Lycée Emile Jacqmain</a>
	</div>
	...
	<div id="userAccount">
    	...
    	<a id="signUp" class="pp_not_loggedIn" href="<?php echo $dig; ?>index.php?page=inscription-1">M'inscrire</a>
