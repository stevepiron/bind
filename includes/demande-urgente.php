		...
		<section id="interactions">
			<ol class="comments">
				<li class="clearfix">
					...
					<article>
						<header>
							<p class="author">Justine <span class="bestAnswersCount" title="4 réponses utiles">4</span></p>
						</header>
				...
				<li class="clearfix">
					...
					<article>
						<header>
							<p class="author">Maxime <span class="bestAnswersCount" title="122 réponses utiles">122</span></p>
						</header>
						<p>C'est Bruneau...</p>
						<footer>
							<span class="publishedDate">Il y a 2 jours</span>
